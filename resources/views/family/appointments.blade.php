...
@section('sidebar-nav')
    ...
    <a href="{{ route('family.appointments.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg bg-sky-50 text-sky-700 font-medium text-sm mt-1">
        📅 My Appointments
    </a>
    <a href="{{ route('family.messages.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-50 font-medium text-sm mt-1">
        💬 Messages
    </a>
