...
@section('sidebar-nav')
    <a href="{{ route('admin.dashboard') }}" @class([
        ...
        'bg-violet-50 text-violet-700' => request()->routeIs('admin.dashboard'),
        'text-gray-600 hover:bg-gray-50 hover:text-gray-800' => !request()->routeIs('admin.dashboard'),
    ])>
        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
        Dashboard
    </a>

    <a href="{{ route('admin.providers.index') }}" @class([
        'flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-colors',
        'bg-violet-50 text-violet-700' => request()->routeIs('admin.providers.*'),
        'text-gray-600 hover:bg-gray-50 hover:text-gray-800' => !request()->routeIs('admin.providers.*'),
    ])>
    ...
    <a href="{{ route('admin.subscriptions.index') }}" @class([
        'flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-colors',
        'bg-violet-50 text-violet-700' => request()->routeIs('admin.subscriptions.*'),
        'text-gray-600 hover:bg-gray-50 hover:text-gray-800' => !request()->routeIs('admin.subscriptions.*'),
    ])>
    ...
    <a href="{{ route('admin.reviews.index') }}" @class([
        'flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-colors',
        'bg-violet-50 text-violet-700' => request()->routeIs('admin.reviews.*'),
        'text-gray-600 hover:bg-gray-50 hover:text-gray-800' => !request()->routeIs('admin.reviews.*'),
    ])>
    ...
    <a href="{{ route('admin.blog.index') }}" @class([
        'flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-colors',
        'bg-violet-50 text-violet-700' => request()->routeIs('admin.blog.*'),
        'text-gray-600 hover:bg-gray-50 hover:text-gray-800' => !request()->routeIs('admin.blog.*'),
    ])>
...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-xs text-gray-400">Configure global platform behaviour</p>
        </div>
    </div>
