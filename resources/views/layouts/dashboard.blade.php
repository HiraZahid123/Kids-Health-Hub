    ...
    <aside class="fixed md:static inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-100 flex flex-col transition-transform duration-300"
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
            ...
            @else
                ...
                <a href="{{ route('pricing') }}" target="_blank" @class(['flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-colors', 'bg-violet-50 text-violet-700' => false, 'text-gray-600 hover:bg-gray-50 hover:text-gray-800' => true])>
