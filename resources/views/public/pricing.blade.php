...
@section('meta_description', 'Simple, transparent pricing for healthcare providers. Start with a free 3-month trial. Then choose monthly or annual — no hidden fees.')
...
<section class="py-16 lg:py-20" style="background:var(--khh-paper);">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-lg text-gray-500 leading-relaxed max-w-xl mx-auto">
            Start with a free 3-month trial — no credit card required. After your trial, choose the plan that works best for your practice.
        </p>
    </div>
</section>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="rounded-2xl px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4" style="background:linear-gradient(115deg,#e9fbf2,#d4f5e5); border:2px solid #0dc066;">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="font-black text-gray-900 text-lg">3-Month Free Trial</p>
                    <p class="text-sm text-gray-600">Every new provider listing starts with a full 3-month free trial. No credit card required to get started.</p>
                </div>
            </div>
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            ...
            <div class="relative rounded-3xl bg-white border-2 border-gray-100 p-8 flex flex-col shadow-sm hover:shadow-md transition-shadow">
                ...
                <div class="flex items-end gap-2 mb-1">
                    <span class="font-black text-gray-900" style="font-size:3rem; line-height:1;">$100</span>
            ...
            <div class="relative rounded-3xl p-8 flex flex-col shadow-lg" style="background:linear-gradient(145deg,#de6148,#e9744e,#fcc333);">
                ...
                <div class="absolute -top-3.5 left-1/2 -translate-x-1/2">
                    <span class="inline-block rounded-full px-4 py-1 text-xs font-black text-white shadow-md" style="background:#1f2937;">⭐ Best Value — Save $200</span>
                </div>

                <p class="text-xs font-black uppercase tracking-[0.18em] mb-3 text-white/80">Annual</p>
                <div class="flex items-end gap-2 mb-1">
                    <span class="font-black text-white" style="font-size:3rem; line-height:1;">$1,000</span>
                    <span class="text-white/70 font-semibold mb-2">AUD / year</span>
                </div>
                <p class="text-sm text-white/75 mb-1">That's just <strong class="text-white">$83/month</strong> — billed annually.</p>
                <p class="text-xs text-white/60 mb-8">Save $200 compared to monthly billing.</p>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr style="background:var(--khh-paper);">
                        ...
                        <th class="text-center px-4 py-4 font-black" style="color:var(--khh-coral);">Monthly<br><span class="font-semibold text-gray-500 text-xs">$100/mo</span></th>
                        <th class="text-center px-4 py-4 font-black" style="color:var(--khh-gold);">Annual<br><span class="font-semibold text-gray-500 text-xs">$1,000/yr</span></th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-50">
                    @php
                    $rows = [
                        ['Public provider listing', true, true],
                        ['Search & category visibility', true, true],
                        ['Telehealth badge', true, true],
                        ['Availability toggle', true, true],
                        ['Appointment requests', true, true],
                        ['Profile views analytics', true, true],
                        ['Family messaging', true, true],
                        ['Priority search placement', false, true],
                        ['Featured provider badge', false, true],
                        ['Annual invoice', false, true],
                        ['Onboarding support', false, true],
                    ];
                    @endphp
                    @foreach($rows as $i => [$label, $monthly, $annual])
                    <tr class="{{ $i % 2 === 0 ? 'bg-white' : 'bg-gray-50/50' }}">
                        <td class="px-6 py-3.5 font-semibold text-gray-700">{{ $label }}</td>
...
<section class="py-12 lg:py-16" style="background:var(--khh-paper);">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-4" x-data="{ open: null }">
            @php
            $faqs = [
                ['q' => 'Do I need a credit card to start the free trial?', 'a' => 'No. Your free 3-month trial starts automatically when you register — no payment details required. You\'ll only be asked for payment when your trial period ends.'],
...
<section class="py-14 lg:py-16" style="background:#fff;">
    <div class="max-w-2xl mx-auto px-4 text-center">
        ...
        <p class="text-gray-500 mb-8 leading-relaxed">Join Australia's growing directory of trusted child healthcare providers. Your first 3 months are completely free.</p>
